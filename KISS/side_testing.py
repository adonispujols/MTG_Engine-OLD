...
# # ^ Or just to make our lives easier/reduCe chance of bugs?
# # ^ NEED TO ENFORCE THEM, HOWEVER, IF THE ARG IS NECESSARY
...
# # ^ BE VERY CAREFUL THAT YOU DON'T FORCE THEM TO WORK WITH STATIC/UNCHANGING
# # ^ GAME REFERENCE! I.e., they won't refer to any new games made!
...
# # TODO Handle invalid input? E.g., given an event that current state can't process?
# # ^ Consider int in choose player. Should we have exceptions around it?
# # ^ Might give clarity/debug/robust boost IF it isn't too messy/inefficient.etc.
# # TODO Make signal class rely on same stuff relevant class needs
# # TODO make event class rely on same params relevant class needs
# # TODO Rename signal class and/or put required/requested responses as a separete object?
# # ^ Just seems weird to do signal.X, instead of respond(needed params) or even the classic
# # ^ advance (input) <- though it's hard to tell ahead of time what the needed params are.
# # TODO Re-Note about passing entire object vs just the stuff you need in it.
# # ^ What's more proper/standard and/or easier for dev?
# # TODO ^ Consider also how to deal with many params!!! What to do about that?
# # ^ How to know you actually need those param or not?
# # Refer to this great thread. We'll readdress this later
...
# # print("Pass" == ev.Events.PASS)
# # print("Pass" == ev.Events.PASS.value)
# # print(type(ev.Events.PASS))
# # print(type(ev.Events.PASS.value))
